    ...
    <div className="bg-white lg:px-20">
      <div className="pt-6">
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="flex flex-wrap space-x-5 justify-center">
              {product.images.map((item) => (
                <div className="aspect-h-2 aspect-w-3 overflow-hidden rounded-lg max-w-[5rem] max-h-[5rem] m-4">
                  <img
                    src={item.src}
                    alt={item.alt}
                    className="h-full w-full object-cover object-center"
              ...
              <div className="mt-6">
                <div className="flex items-center space-x-3">
                  <Rating
                    ...
                    precision={0.5}
                  />
                  <p className="opacity-50 text-sm">5465 Ratings</p>
            ...
            <Grid container spacing={7}>
              ...
              <Grid item xs={5}>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <p className="opacity-60">4532 Ratings</p>
                </div>

                <Box className="mt-5 text-left space-y-5">
        ...
        <section className="pt-10">
          <h1 className="py-5 ext-xl font-bold">Similar Products</h1>
